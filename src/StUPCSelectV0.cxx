...
int StUPCSelectV0::selectTracks(vector<StUPCTrack>& tracks, std::vector<UChar_t>& sel, StUPCEvent *upcEvent, TVector3 const & vertex, vector<TH1D*>& hists1D, vector<TH2D*>& hists2D) {
