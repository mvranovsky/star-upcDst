#ifndef AnaV0Control_h
#define AnaV0Control_h
...
class AnaV0Control : public Ana{
   public:
      AnaV0Control(TFile *outFile);
      ~AnaV0Control(){};
   ...
   private:
      ...
      TH1D *hPosZCut, *hVtxDiff, *hNPairs, *hSameTrackPair, *hBothFlags;
