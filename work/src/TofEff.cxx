...
void TofEff::Make(){
   ...
   SaveTrackInfo(mUpcEvt->getTrack(bestPair.first), 0);
   SaveTrackInfo(mUpcEvt->getTrack(bestPair.second), 1);
...
void TofEff::Init(){
   ...
   mRecTree = new RecTree(nameOfAnaTofEff, TofEffTreeBits, false); 
