...
const bool V0Control = true; // used in runAnaV0, runAnaSingleState: true=kPrimary, false=kV0
...
const bool usePrimVtx = true;  // condition whether to use or not to use primary vertex in the analysis
