...
const bool runAnaZeroBias = true;
...
const TString nameOfZeroBiasTree = "recTreeZeroBias";
const std::bitset<16> ZeroBiasTreeBits = std::bitset<16>(std::string("0000000001001001")); 
